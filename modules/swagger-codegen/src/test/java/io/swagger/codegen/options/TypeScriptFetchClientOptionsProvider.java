...
public class TypeScriptFetchClientOptionsProvider implements OptionsProvider {
    ...
    public static final Boolean USE_CUSTOM_ASSIGN_POLYFILL_VALUE = false;
    ...
    public Map<String, String> createOptions() {
        ...
        return builder.put(CodegenConstants.SORT_PARAMS_BY_REQUIRED_FLAG, SORT_PARAMS_VALUE)
                ...
                .put(CodegenConstants.USE_CUSTOM_ASSIGN_POLYFILL, String.valueOf(USE_CUSTOM_ASSIGN_POLYFILL_VALUE))
                .build();
    }
